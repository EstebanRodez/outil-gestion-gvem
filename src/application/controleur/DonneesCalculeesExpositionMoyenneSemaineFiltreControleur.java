/*
 * DonneesCalculeesExpositionMoyenneSemaineFiltreControleur.java                           
 * 9 nov. 2024
...
/**
 * Contrôleur des données calculées des expositions en moyenne par jour avec
 * filtres
 * 
 * @author Romain Augé
 * @author Ayoub Laluti
 ...
 * @version 1.0
 */
public class DonneesCalculeesExpositionMoyenneSemaineFiltreControleur {
    ...
    void btnValiderAction(ActionEvent event) {
        ...
        DonneesCalculeesExpositionMoyenneSemaineControleur controleurPrincipal;
        controleurPrincipal = EchangeurDeVue
                               .getFXMLLoader("donneesCalculeesExpositionMoyenneSemaineVue")
                                .getController();
        controleurPrincipal.appliquerFiltreMoyenneJour(critere);
            
        // Fermer la popup
        EchangeurDeVue.fermerPopUp("donneesCalculeesExpositionMoyenneSemaineFiltrePopUp");
    }
