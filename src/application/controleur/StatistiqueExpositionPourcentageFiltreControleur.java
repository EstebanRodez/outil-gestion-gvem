/*
 * StatistiqueExpositionPourcentageFiltreControleur.java                           
 * 16 nov. 2024
...
/**
 * Contrôleur des pourcentages des expositions avec filtres
 * 
 * @author Romain Augé
 * @author Ayoub Laluti
 ...
 * @version 1.0 
 */
public class StatistiqueExpositionPourcentageFiltreControleur {
    ...
    void btnValiderAction(ActionEvent event) {
        ...
        StatistiqueExpositionPourcentageControleur controleurPrincipal;
        controleurPrincipal = EchangeurDeVue
                               .getFXMLLoader("statistiqueExpositionPourcentageVue")
                                .getController();
