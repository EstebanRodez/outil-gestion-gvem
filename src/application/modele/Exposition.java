...
public class Exposition {
	...
	/**
     * Initialise une nouvelle exposition avec un identifiant, un intitulé,
     *  une période, un nombre d'oeuvres, une liste de mots clés et un résumé
     * @param identifiant l'identifiant/code de l'exposition
     * @param intitule le nom ou la désignation de l'exposition
     * @param periodeDeb est le début de la période durant laquelle aura lieu 
     * 		  l'exposition
     * @param periodeFin est la fin de la période durant laquelle aura lieu 
     * 		  l'exposition
     * @param nbOeuvre le nombre d'oeuvre présent dans l'exposition
     * @param motsCles liste de mots clés par lequels 
     * 		  on peut retrouver l'exposition
     * @param resume résumé de l'exposition
     * @throws IllegalArgumentException si la référence de l'identifiant
     *                                  est nul ou l'identifiant est vide
     * @throws IllegalArgumentException si la référence de l'intitulé
     *                                  est nul ou l'intitulé est vide
     * @throws IllegalArgumentException si la référence de est nul ou vide
     * @throws IllegalArgumentException si la référence du nombre d'oeuvre
     *                                  est nul ou vide
     * @throws IllegalArgumentException si la référence de la liste des 
     * 									mots clés est nul ou vide
     * @throws IllegalArgumentException si la référence du résumé
     *                                  est nul ou vide
     * @throws IllegalArgumentException si le nombre de mots clés est > 10
     */
	public Exposition (String identifiant,String intitule, int periodeDeb, int periodeFin, int nbOeuvre, String[] motsCles, String resume) {
		...
		if(periodeDeb <= 0 || periodeFin <= 0
		   || periodeDeb > periodeFin) {
