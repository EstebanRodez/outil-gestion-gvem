...
/**
 * La classe ImportationCSV permet d'importer et de traiter des données à partir
 * d'un fichier CSV, en créant des objets Exposition ou ExpositionTemporaire 
...
public class ImportationCSV {
     ...
     */
    public static List<String[]> importer(String lienFichier) throws IOException {
     ...
     * 
     * @param donnee La liste des données CSV représentant des expositions.
     * @throws IllegalArgumentException si le nombre d'argument d'une ligne est 
     *                                  incorrect.
     */
                ...
                if (ligne.length == 7) { // Exposition normale
                    ...
                    expoTemporaire 
                        = new ExpositionTemporaire(identifiant, intitule,
                                    periodeDebut, periodeFin, nbOeuvre, motsCles, 
