...
class TestExposition {
    ...
    private final String RESUME_EXPO_VALIDE = "Très belle exposition sur l'impressionnisme.";
    ...
    void testExpositionInvalide() {
        ...
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(null, INTITULE_EXPO_VALIDE, PERIODEDEB_EXPO_VALIDE, 
                                          PERIODEFIN_EXPO_VALIDE, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition("", INTITULE_EXPO_VALIDE, PERIODEDEB_EXPO_VALIDE, 
                                          PERIODEFIN_EXPO_VALIDE, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        
        // Test avec intitulé null ou vide
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, null, PERIODEDEB_EXPO_VALIDE, 
                                          PERIODEFIN_EXPO_VALIDE, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, "", PERIODEDEB_EXPO_VALIDE, 
                                          PERIODEFIN_EXPO_VALIDE, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        
        // Test avec périodes invalides
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          2025, 1880, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          -10, 1880, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          1880, 0, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          0, 0, NBOEUVRE_EXPO_VALIDE, 
                                          MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        ...
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          ...
                                          0, MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
                                          -5, MOTSCLES_EXPO_VALIDE, RESUME_EXPO_VALIDE));
        
        // Test avec liste de mots-clés invalide
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
                                          NBOEUVRE_EXPO_VALIDE, null, RESUME_EXPO_VALIDE));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
        ...
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          ...
                                          new String[]{"clé1", "clé2", "clé3", "clé4", 
                                                       "clé5", "clé6", "clé7", "clé8", 
                                                       "clé9", "clé10", "clé11"}, 
                                          RESUME_EXPO_VALIDE));
        ...
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
                                          NBOEUVRE_EXPO_VALIDE, MOTSCLES_EXPO_VALIDE, null));
        assertThrows(IllegalArgumentException.class, 
                     () -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                          PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
    ...
    void testExpositionValide() {
        assertDoesNotThrow(() -> new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                                PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
                                                NBOEUVRE_EXPO_VALIDE, MOTSCLES_EXPO_VALIDE, 
                                                RESUME_EXPO_VALIDE));
    }
    ...
    void testGetIntitule() {
        Exposition expo = new Exposition(IDENTIFIANT_EXPO_VALIDE, INTITULE_EXPO_VALIDE, 
                                         PERIODEDEB_EXPO_VALIDE, PERIODEFIN_EXPO_VALIDE, 
                                         NBOEUVRE_EXPO_VALIDE, MOTSCLES_EXPO_VALIDE, 
                                         RESUME_EXPO_VALIDE);
   ...
   /**
    ...
    void testGetMotsCles() {
        assertArrayEquals(new String[] {"Romain", "Ayoub", "Esteban", "Baptiste", "paysage", "mars"}, EXPO_VALIDES[0].getMotsCles());
        assertArrayEquals(new String[] {"cubisme", "oeuvre", "abstrait", "art moderne"}, EXPO_VALIDES[1].getMotsCles());
        
        assertNotEquals(new String[] {"abstrait"}, EXPO_VALIDES[1].getMotsCles());
    }
    ...
    @Test
    void testGetResume() {
        assertEquals("Une grande exposition sur des paysages originaux et audacieux", EXPO_VALIDES[0].getResume());
        assertEquals("Une exposition d'œuvres cubistes influentes.", EXPO_VALIDES[1].getResume());
